 ...
 */
final class Version20230507173933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profesional_category ADD CONSTRAINT FK_BD7FFD6AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_profesional_category ADD CONSTRAINT FK_BD7FFD6AFB78D177 FOREIGN KEY (profesional_category_id) REFERENCES profesional_category (id) ON DELETE CASCADE');
    }
