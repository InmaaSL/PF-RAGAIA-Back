 ...
 */
final class Version20230507174254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_centre (user_id INT NOT NULL, centre_id INT NOT NULL, INDEX IDX_A3F2F148A76ED395 (user_id), INDEX IDX_A3F2F148463CD7C3 (centre_id), PRIMARY KEY(user_id, centre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
