...
class PostMessageRepository extends ServiceEntityRepository
{
    ...
    public function save(PostMessage $entity, bool $flush = false): void
    {
    ...
    public function remove(PostMessage $entity, bool $flush = false): void
    {
...
//    /**
//     * @return PostMessage[] Returns an array of PostMessage objects
//     */
...
//    public function findOneBySomeField($value): ?PostMessage
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
